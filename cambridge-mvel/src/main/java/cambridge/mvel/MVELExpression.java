...
public class MVELExpression implements Expression {
   ...
   public MVELExpression(Serializable compiledExpression, String expression) {
   ...
   public Object eval(Map<String, Object> globals) throws ExpressionEvaluationException {
      ...
      try {
         ...
         throw new ExpressionEvaluationException("Error evaluating exception: " + expression, e);
      }
   }
