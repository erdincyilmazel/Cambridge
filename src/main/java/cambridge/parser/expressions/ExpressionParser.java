   ...
   public final Expression.Operator relationalOp() throws RecognitionException {
      ...
      try {
         ...
         if ((LA9_0 == LT)) {
            ...
            if ((LA9_1 == EQ)) {
               alt9 = 1;
            } else if (((LA9_1 >= IDENTIFIER && LA9_1 <= NULL) || (LA9_1 >= SUPER && LA9_1 <= LPAREN) || (LA9_1 >= BANG && LA9_1 <= TILDE))) {
               alt9 = 3;
            } else {
               NoViableAltException nvae =
            ...
            if ((LA9_2 == EQ)) {
               alt9 = 2;
            } else if (((LA9_2 >= IDENTIFIER && LA9_2 <= NULL) || (LA9_2 >= SUPER && LA9_2 <= LPAREN) || (LA9_2 >= BANG && LA9_2 <= TILDE))) {
               alt9 = 4;
            } else {
               NoViableAltException nvae =
      ...
      try {
         ...
         if ((LA11_0 == LT)) {
            ...
            if ((LA11_2 == GT)) {
               ...
               if ((LA11_3 == GT)) {
                  alt11 = 2;
               } else if (((LA11_3 >= IDENTIFIER && LA11_3 <= NULL) || (LA11_3 >= SUPER && LA11_3 <= LPAREN) || (LA11_3 >= BANG && LA11_3 <= TILDE))) {
                  alt11 = 3;
               } else {
                  NoViableAltException nvae =
